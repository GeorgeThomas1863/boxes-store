...
describe("buildAboutForm — footer", () => {
  ...
  it("first row label is 'Ownership'", async () => {
    const container = await buildAboutForm();
  ...
  it("first row value mentions 'Registered Nurse'", async () => {
    const container = await buildAboutForm();
    const rows = container.querySelectorAll(".about-footer-row");
  ...
  it("second row label is 'Based In'", async () => {
    const container = await buildAboutForm();
    const rows = container.querySelectorAll(".about-footer-row");
  ...
  it("second row value is 'Western North Carolina'", async () => {
    const container = await buildAboutForm();
    const rows = container.querySelectorAll(".about-footer-row");
